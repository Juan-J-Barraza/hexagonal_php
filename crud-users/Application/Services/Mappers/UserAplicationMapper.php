...
final class UserAplicationMapper
{
    public static function fromCreatedCommandToUserModel(CreateUserCommand $command): UserModel
    {
    ...
    public static function fromUpdatedCommandToUserModel(UpdateUserCommand $command): UserModel
    {
        return new UserModel(
            new UserId($command->getId()),
            new UserName($command->getName()),
